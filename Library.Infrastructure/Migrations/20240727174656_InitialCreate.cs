    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LibraryInventories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Books_LibraryInventories_InventoryId",
                        column: x => x.InventoryId,
                        principalTable: "LibraryInventories",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BooksCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    BookId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RentOrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RentedBooks_RentOrders_RentOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentedBooks_RentOrderId",
                table: "RentedBooks",
                column: "RentOrderId");
